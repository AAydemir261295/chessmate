...
public class WhiteQueen extends WhiteFigure implements Serializable {
    ...
    public WhiteQueen(int x, int y, String cellColor, String figure) {
    ...
    public HasDirection getDirection() {
        return new LineIsEmptyWhiteQueen();
    }

    private boolean moveIsCorrect(ToCoordinateParser figurePosition, ToCoordinateParser moveCoordinate) {
        LineIsEmptyWhiteQueen queenDirection = new LineIsEmptyWhiteQueen();
        return queenDirection.checkDirection(figurePosition, moveCoordinate) == 1;
    }
    ...
    private void moveFigure(ToCoordinateParser moveCoordinate) {
        ...
        board.getBoard().add(index, new WhiteQueen(x, y, cellColor, WhiteFigures.QUEEN.getFigure()));
