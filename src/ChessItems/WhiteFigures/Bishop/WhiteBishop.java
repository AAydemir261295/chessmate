...
public class WhiteBishop extends WhiteFigure implements Serializable {
    ...
    public WhiteBishop(int x, int y, String cellColor, String figure) {
    ...
    public HasDirection getDirection() {
        return new LineIsEmptyWhiteBishop();
    }

    private boolean moveIsCorrect(ToCoordinateParser figurePosition, ToCoordinateParser moveCoordinate) {
        LineIsEmptyWhiteBishop bishopDirection = new LineIsEmptyWhiteBishop();
    ...
    private void moveFigure(ToCoordinateParser moveCoordinate) {
        ...
        board.getBoard().add(index, new WhiteBishop(x, y, cellColor, WhiteFigures.BISHOP.getFigure()));
