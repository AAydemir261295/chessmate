...
public class BlackBishop extends BlackFigure implements Serializable {
    ...
    public BlackBishop(int x, int y, String cellColor, String figure) {
    ...
    public HasDirection getDirection() {
        return new LineIsEmptyBlackBishop();
    }
    ...
    private boolean moveIsCorrect(ToCoordinateParser figurePosition, ToCoordinateParser moveCoordinate) {
        LineIsEmptyBlackBishop bishopDirection = new LineIsEmptyBlackBishop();
        return bishopDirection.checkDirection(figurePosition, moveCoordinate) == 1;
    }
    ...
    private void moveFigure(ToCoordinateParser moveCoordinate) {
        ...
        board.getBoard().add(index, new BlackBishop(x, y, cellColor, BlackFigures.BISHOP.getFigure()));
