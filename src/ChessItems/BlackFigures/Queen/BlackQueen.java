...
public class BlackQueen extends BlackFigure implements Serializable {
    ...
    public BlackQueen(int x, int y, String cellColor, String figure) {
    ...
    public HasDirection getDirection() {
        return new LineIsEmptyBlackQueen();
    }
    ...
    private boolean moveIsCorrect(ToCoordinateParser figurePosition, ToCoordinateParser moveCoordinate) {
        LineIsEmptyBlackQueen queenDirection = new LineIsEmptyBlackQueen();
    ...
    private void moveFigure(ToCoordinateParser moveCoordinate) {
        ...
        board.getBoard().add(index, new BlackQueen(x, y, cellColor, BlackFigures.QUEEN.getFigure()));
